...
<div class="card mt-4">
  <div class="card-header">
    <h5 class="mb-0">Edit Jenis Pendanaan: {{ $jenisPendanaan->nama }}</h5>
  </div>
  <div class="card-body">
    <form action="{{ route('jenis-pendanaan.update', $jenisPendanaan->id) }}" method="POST">
      @csrf
      @method('PUT')
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('nama') is-invalid @enderror"
               id="nama" name="nama" value="{{ old('nama', $jenisPendanaan->nama) }}"
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                  ...
                  placeholder="Deskripsi singkat tentang jenis pendanaan ini (opsional)">{{ old('deskripsi', $jenisPendanaan->deskripsi) }}</textarea>
        @error('deskripsi')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
      </div>
      ...
      <div class="mb-3">
        <div class="form-check form-switch">
          <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                 {{ old('is_active', $jenisPendanaan->is_active) ? 'checked' : '' }}>
