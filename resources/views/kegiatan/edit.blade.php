...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
    <div class="mb-3 mb-md-0">
        <h4 class="fw-bold text-primary mb-1">
            <i class="bx bx-edit"></i> Edit Usulan Kegiatan
        </h4>
        <p class="text-muted mb-0">Perbarui informasi usulan kegiatan</p>
    </div>
        ...
        <form action="{{ route('kegiatan.update', $kegiatan) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('jenis_kegiatan') is-invalid @enderror"
                                ...
                                <option value="seminar" {{ old('jenis_kegiatan', $kegiatan->jenis_kegiatan) == 'seminar' ? 'selected' : '' }}>Seminar</option>
                                <option value="workshop" {{ old('jenis_kegiatan', $kegiatan->jenis_kegiatan) == 'workshop' ? 'selected' : '' }}>Workshop</option>
                                <option value="pelatihan" {{ old('jenis_kegiatan', $kegiatan->jenis_kegiatan) == 'pelatihan' ? 'selected' : '' }}>Pelatihan</option>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi_kegiatan') is-invalid @enderror"
                                      ...
                                      rows="4" placeholder="Jelaskan detail kegiatan yang akan dilaksanakan">{{ old('deskripsi_kegiatan', $kegiatan->deskripsi_kegiatan) }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('jenis_pendanaan') is-invalid @enderror"
                                ...
                                <option value="mandiri" {{ old('jenis_pendanaan', $kegiatan->jenis_pendanaan) == 'mandiri' ? 'selected' : '' }}>Mandiri</option>
                                <option value="sponsor" {{ old('jenis_pendanaan', $kegiatan->jenis_pendanaan) == 'sponsor' ? 'selected' : '' }}>Sponsor</option>
                                <option value="hibah" {{ old('jenis_pendanaan', $kegiatan->jenis_pendanaan) == 'hibah' ? 'selected' : '' }}>Hibah</option>
                                <option value="internal" {{ old('jenis_pendanaan', $kegiatan->jenis_pendanaan) == 'internal' ? 'selected' : '' }}>Internal Kampus</option>
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_akhir') is-invalid @enderror"
                                   ...
                                   value="{{ old('tanggal_akhir', $kegiatan->tanggal_akhir->format('Y-m-d')) }}">
                            @error('tanggal_akhir')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bx bx-save me-1"></i> Update Usulan
                </button>
            </div>
        </form>
    </div>
