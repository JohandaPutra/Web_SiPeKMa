                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('jenis_kegiatan_id') is-invalid @enderror"
                                ...
                                @foreach($jenisKegiatans as $jenis)
                                    <option value="{{ $jenis->id }}" {{ old('jenis_kegiatan_id', $kegiatan->jenis_kegiatan_id) == $jenis->id ? 'selected' : '' }}>
                                        {{ $jenis->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('jenis_pendanaan_id') is-invalid @enderror"
                                ...
                                @foreach($jenisPendanaans as $jenis)
                                    <option value="{{ $jenis->id }}" {{ old('jenis_pendanaan_id', $kegiatan->jenis_pendanaan_id) == $jenis->id ? 'selected' : '' }}>
                                        {{ $jenis->nama }}
                                    </option>
                                @endforeach
                            </select>
