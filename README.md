# Sipekma - Sistem Informasi Usulan Kegiatan

Laravel 11 application with Sneat Bootstrap admin template for activity proposal management.

## Features

- 🎯 Complete CRUD for Usulan Kegiatan (Activity Proposals)
...
- **Template**: Sneat Bootstrap Admin
- **Database**: MySQL
- **UI Components**: DataTables, Toast Notifications
...
### Usulan Kegiatan Table
- `nama_kegiatan`: Activity name
- `deskripsi_kegiatan`: Activity description  
- `jenis_kegiatan`: Activity type (internal/eksternal)
- `tempat_kegiatan`: Activity location
- `tanggal_mulai`: Start date
- `tanggal_akhir`: End date
- `jenis_pendanaan`: Funding type (mandiri/sponsor/hibah)
- `status_kegiatan`: Status (diajukan/disetujui/ditolak/selesai)
